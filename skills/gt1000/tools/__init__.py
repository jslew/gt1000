...
def _avoid_repo_pycache() -> None:
    # The skill package should remain free of generated __pycache__/pyc artifacts.
    # Redirect any bytecode cache to a temp directory and disable bytecode writes by default.
